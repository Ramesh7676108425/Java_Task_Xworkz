...
public class Facebook {
	...
	public Facebook() {
      ...
      System.out.println("userName is:"+this.userName);
       ...
       public Facebook(String userName,int numberOfFollowers) {
       ...
       public Facebook(String userName,int numberOfFollowers,boolean isPrivate) {
      ...
      this.userName=userName;
       ...
       public Facebook(String userName,int numberOfFollowers,boolean isPrivate,int numberOfFollowing) {
      ...
      this.userName=userName;
       ...
       public Facebook(String userName,int numberOfFollowers,boolean isPrivate,int numberOfFollowing,String bio) {
       ...
       public Facebook(String userName,int numberOfFollowers,boolean isPrivate,int numberOfFollowing,String bio,int post) {
